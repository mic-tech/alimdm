...
Ali MDM offers two main integration methods:
...
**Topic structure:**
```
alimdm/lobby/availability         # Device online/offline
alimdm/lobby/state                # All sensor data (JSON)
alimdm/lobby/set/brightness       # Set brightness command
alimdm/lobby/set/url              # Navigate to URL
```
