...
1. Open Ali MDM from the app drawer
...
Settings → Apps → Ali MDM → Uninstall


## Quick FAQ

**Do I need to root my tablet?**
No! Ali MDM uses Android's official Device Owner API.

**Can I use Ali MDM without Device Owner?**
