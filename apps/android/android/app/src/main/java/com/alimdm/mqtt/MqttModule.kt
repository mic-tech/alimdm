...
class MqttModule(private val reactContext: ReactApplicationContext) :
    ...
    fun startMqtt(configMap: ReadableMap, promise: Promise) {
        try {
            ...
            val config = MqttConfig(
                ...
                baseTopic = if (configMap.hasKey("baseTopic")) configMap.getString("baseTopic") ?: "alimdm" else "alimdm",
            ...
            client.commandHandler = { command, params ->
                ...
                when (command) {
                    ...
                    "setMode" -> {
                        ...
                        // bring AliMDM to the front from native code so the JS onSetMode
            ...
            val appVersion = com.alimdm.BuildConfig.VERSION_NAME
            ...
            com.alimdm.KioskWatchdogService.startKeepAliveIfNeeded(reactContext.applicationContext)
    ...
    /**
     * #209: Bring AliMDM's MainActivity to the foreground from native code, so a setMode
