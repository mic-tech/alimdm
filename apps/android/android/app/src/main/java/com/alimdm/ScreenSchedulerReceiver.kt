...
class ScreenSchedulerReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_SCREEN_WAKE = "com.alimdm.ACTION_SCHEDULED_SCREEN_WAKE"
        const val ACTION_SCREEN_SLEEP = "com.alimdm.ACTION_SCHEDULED_SCREEN_SLEEP"
    ...
    private fun handleWake(context: Context) {
        ...
        try {
            ...
            try {
                ...
                val activityClass = Class.forName("com.alimdm.MainActivity")
