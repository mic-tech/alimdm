...
class OverlayServiceModule(reactContext: ReactApplicationContext) :
    ...
    // in External App mode (JS timers are frozen while AliMDM is backgrounded). Uses a
    ...
    fun setButtonOpacity(opacity: Double, promise: Promise) {
        try {
            ...
            val prefs = reactApplicationContext.getSharedPreferences("AliMdmSettings", android.content.Context.MODE_PRIVATE)
