# Ali MDM Deployment Script for Mac

This directory contains a deployment script to help set up Ali MDM as a Device Owner on Android tablets.
...
Place your Ali MDM APK file in this `scripts/` directory. The APK should be named in the format:
```
alimdm-v*.apk
```

For example: `alimdm-v1.0.0.apk`
...
- Locate the Ali MDM APK
- Verify device connection
- Install the APK
- Set Ali MDM as Device Owner
...
- Ali MDM will be set as the Device Owner
- The app will have special permissions to manage the device
- You can configure kiosk settings within the Ali MDM app
