          ...
          {dashboardModeEnabled ? (
            ...
            <>
              <SettingsInput
                ...
                keyboardType="url"
                hint="Example: https://www.example.com"
              />
...
`}
      ...
      {displayMode === 'webview' && (
        <SettingsSection title="Website Authentication" icon="lock-outline">
          ...
          <SettingsInfoBox variant="info">
            <Text style={styles.infoText}>
              When a website returns a 401 Unauthorized response, Ali MDM will automatically reply with these credentials. Leave username empty to disable.
            </Text>
          </SettingsInfoBox>
        </SettingsSection>
      )}
          ...
          >
            <View style={styles.permissionRow}>
              <View style={styles.permissionTextContainer}>
                ...
                <Text style={styles.permissionHint}>
                  {hasUsageStatsPermission
                    ? "Auto-relaunch monitoring is active. Ali MDM can detect when the external app closes."
                    : "Required for auto-relaunch. Without this, Ali MDM cannot detect when the external app closes or crashes."}
                </Text>
              </View>
            </View>
