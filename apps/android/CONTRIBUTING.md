# Contributing to Ali MDM

Thank you for considering contributing to Ali MDM! 🎉

## How to Contribute

### Reporting Bugs

1. Check if the bug already exists in [Issues](https://github.com/rushb/alimdm/issues)
2. If not, create a new issue with:
   - **Device model** (e.g., Samsung Galaxy Tab A8)
   - **Android version** (e.g., Android 12)
   - **Ali MDM version** (e.g., v1.0.1)
   - **Steps to reproduce**
   - **Expected behavior**
   - **Actual behavior**
...
**Thank you for making Ali MDM better! 🚀**
